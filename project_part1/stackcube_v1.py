...
if __name__=="__main__":
    num_envs = 32 # you can increases this and decrease the n_steps parameter if you have more cores to speed up training
    env_id = "StackCube-v1" #"LiftCube-v1"
    obs_mode = "state"
    ...
    # Train with SAC
    model.learn(7_000_000, callback=[checkpoint_callback, eval_callback])
